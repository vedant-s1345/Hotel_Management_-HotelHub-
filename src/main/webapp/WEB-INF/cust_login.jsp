...
<head>
    ...
    <title>Customer Portal | HotelHub</title>
    ...
    <style>
        ...
        * {
        ...
        body::before {
            ...
            right: 0;
            bottom: 0;
            background-image: url('data:image/svg+xml;utf8,<svg width="100" height="100" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path fill="%23e2e8f0" fill-opacity="0.2" d="M50 0L100 50L50 100L0 50Z"/></svg>');
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="navbar-actions">
            <a href="/hotel" class="btn-outline">Hotel Login</a>
        </div>
    </nav>
        ...
        <div class="auth-container">
            <div class="auth-image">
                <div class="auth-image-content">
                    ...
                    <p>Join thousands of travelers finding their ideal accommodations with us</p>
                    <ul>
                        <li><i class="fas fa-search"></i> Find hotels that match your preferences</li>
                        <li><i class="fas fa-percent"></i> Exclusive member discounts</li>
                        <li><i class="fas fa-heart"></i> Save your favorite properties</li>
                        <li><i class="fas fa-clock"></i> Quick and easy booking process</li>
            ...
            <div class="auth-forms">
                <div class="auth-header">
                    ...
                    <p>Access your personal travel dashboard</p>
                </div>
                ...
                <div id="login" class="tab-content active">
                    <form action="cust_login" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" id="login-username" name="cusername" class="form-control" placeholder="Enter your username" required>
                            <i class="fas fa-user input-icon"></i>
                        </div>
                        <div class="form-group">
                            <label for="login-password">Password</label>
                            <input type="password" id="login-password" name="cpassword" class="form-control" placeholder="Enter your password" required>
                    ...
                    <div class="auth-footer">
                        Don't have an account? <a href="#" onclick="switchTab('signup')">Create one now</a>
                    </div>
                </div>
                ...
                <div id="signup" class="tab-content">
                    <form action="cust_signup" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" id="signup-username" name="cusername" class="form-control" placeholder="Choose a username" required>
                            <i class="fas fa-user input-icon"></i>
                        </div>
                        <div class="form-group">
                            <label for="signup-email">Email Address</label>
                            <input type="email" id="signup-email" name="cemail" class="form-control" placeholder="your@email.com" required>
                            <i class="fas fa-envelope input-icon"></i>
                        </div>
                        <div class="form-group">
                            <label for="signup-password">Password</label>
                            <input type="password" id="signup-password" name="cpassword" class="form-control" placeholder="Create a password" required>
